...
export { ProfissionalIcon } from './ProfissionalIcon';
export { SaudeIcon } from './SaudeIcon';
export { JuridicoIcon } from './JuridicoIcon';
export { FilmesIcon } from './FilmesIcon';
export { AppsIcon } from './AppsIcon';
export { NoticiasIcon } from './NoticiasIcon';
export { ComecarIcon } from './ComecarIcon';
